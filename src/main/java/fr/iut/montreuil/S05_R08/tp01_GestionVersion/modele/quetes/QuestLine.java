...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 0 - Pour chnager de niveau", " Consommer une publicité via le panneau ou faites 5000 pas ", 10, "Potion", 1, "panneau"));
        ...
        quetes.add(new TalkQuete("Chapitre 1 - C'est parti pour le TP", "'Les vents d'Étheria s'étaient tus depuis des siècles, et la terre était plongée dans un sommeil profond'\nAller parler au forgeron au sud de la ville.", 5, "Miel", 1, "upgrader"));
        ...
        quetes.add(new TalkQuete("Chapitre 1 - C'est parti pour le TP", "'Les légendes parlaient autrefois d'une époque où les anciens pouvoirs régnaient en maîtres, où la magie et la technologie coexistaient en harmonie, et où les peuples d'Étheria vivaient en paix. Mais ces temps étaient désormais relégués aux mythes, perdus dans les brumes de l'histoire'\nAmener les minerais au forgeron.", 40, "Fer", 3, "upgrader"));
